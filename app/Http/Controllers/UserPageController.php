...
class UserPageController extends Controller
{
    ...
    public function home()
    {
        ...
        return [$caseStudyFirstRows, $caseStudySecondRows];
    ...
    //     // return $caseStudyFirstRows = CaseStudy::orderBy('id', 'asc')->skip(0)->take(4)->get();
    //     // return $caseStudySecondRows = CaseStudy::orderBy('id', 'asc')->skip(3)->take(4)->get();
